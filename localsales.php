...
<td><input class="form-control" id="quantity" type="text" name="quantity" placeholder="enter the quantity" align="center" style="width:380px;font-size:10pt" ng-model="quantity" ></td>
</tr>
<tr height="35px">
...
if(isset($_POST['save']))
{
	...
	$insert="insert into ftd_local_sales(Tran_Date,Fran_Name,Bmc_Code,Bmc_Name,Qty,Fat,Snf,Amount,Add_Date,Add_user,D_Flag)values('".$_POST['date']."','".$_POST['Franchise']."','".$bmc[0]."','".$bmc[1]."',".$_POST['quantity'].",".$_POST['fat'].",".$_POST['snf'].",".$_POST['amount'].",'".date("Y-m-d")."','".$_SESSION['login_user']."','A');";
